...
public class JwtTest {
	...
	public void test_pkcs8_pem() {
		String token = GamUtilsEO.createJwt(path_RSA_sha256_2048 + "sha256d_key.pem", "", "", payload, header);
	...
	public void test_pkcs8_key() {
		String token = GamUtilsEO.createJwt(path_RSA_sha256_2048 + "sha256d_key.key", "", "", payload, header);
		Assert.assertFalse("test_pkcs8 create", token.isEmpty());
	...
	public void test_pkcs8_encrypted() {
		String token = GamUtilsEO.createJwt(path_RSA_sha256_2048 + "sha256_key.pem", "", password, payload, header);
	...
	public void test_pkcs12_p12() {
		String token = GamUtilsEO.createJwt(path_RSA_sha256_2048 + "sha256_cert.p12", alias, password, payload, header);
	...
	public void test_pkcs12_pkcs12() {
		String token = GamUtilsEO.createJwt(path_RSA_sha256_2048 + "sha256_cert.pkcs12", alias, password, payload, header);
	...
	public void test_pkcs12_jks() {
		String token = GamUtilsEO.createJwt(path_RSA_sha256_2048 + "sha256_cert.jks", alias, password, payload, header);
	...
	public void test_pkcs12_pfx() {
		String token = GamUtilsEO.createJwt(path_RSA_sha256_2048 + "sha256_cert.pfx", alias, password, payload, header);
	...
	public void test_pkcs12_noalias() {
		String token = GamUtilsEO.createJwt(path_RSA_sha256_2048 + "sha256_cert.jks", "", password, payload, header);
