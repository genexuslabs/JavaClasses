...
public class ExcelDoc {
	...
	public void setDateFormat(LocalUtil localUtil, int lenDate, int lenTime, int ampmFmt, int dateFmt, String dSep,
			String tSep, String dtSep) {
	...
	// public short RunMacro(short xlHandle, String Macro, Variant Arg1, Variant
	// Arg2, Variant Arg3, Variant Arg4, Variant Arg5, Variant Arg6, Variant Arg7,
	// Variant Arg8, Variant Arg9, Variant Arg10, Variant Arg11, Variant Arg12,
	// Variant Arg13, Variant Arg14, Variant Arg15, Variant Arg16, Variant Arg17,
	// Variant Arg18, Variant Arg19, Variant Arg20, Variant Arg21, Variant Arg22,
	// Variant Arg23, Variant Arg24, Variant Arg25, Variant Arg26, Variant Arg27,
