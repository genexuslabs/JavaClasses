...
public class GxOffice implements ICleanedup
{
	...
	// ------------------------------------ xlsGets -----------------------------------------
	public int gxxget(double handle, String[] value, double row, double col, String[] font, double[] size, long[] color)
	{	
	...
	public int gxxget(double handle, short[] value, double row, double col, String[] font, double[] size, long[] color)
	{
		gxxgetformat((long) handle, (int) row, (int) col, color, font, size);
		return gxxget((long) handle, (int) row, (int) col, value);
	}
	...
	public int gxxget (double handle, double[] value, double row, double col, String[] font, double[] size, long[] color)
	{				
		gxxgetformat((long) handle, (int) row, (int) col, color, font, size);
		return gxxget((long) handle, (int) row, (int) col, value);
	}
	...
	public int gxxget(double handle, java.util.Date[] value, double row, double col, String[] font, double[] size, long[] color)
	{				
		gxxgetformat((long) handle, (int) row, (int) col, color, font, size);
		return gxxget((long) handle, (int) row, (int) col, value);
	}

	public int gxxget(double handle, BigDecimal[] value, double row, double col, String[] font, double[] size, long[] color)
	{	
		gxxgetformat((long) handle, (int) row, (int) col, color, font, size);
		return gxxget((long) handle, (int) row, (int) col, value);
	}
	...
	// -
	// ------------------------------------ xlsGets BigDecimal -----------------------------------------
	public int gxxget(double handle, String[] value, double row, double col, String[] font, BigDecimal[] size, long[] color)
	{	
	...
	public int gxxget(double handle, byte[] value, double row, double col, String[] font, BigDecimal[] size, long[] color)
	{
		double[] dsize = new double[1];
		int ret = gxxget(handle, value, row, col, font, dsize, color);
		size[0] = new BigDecimal(dsize[0]);
	...
	public int gxxget(double handle, short[] value, double row, double col, String[] font, BigDecimal[] size, long[] color)
	{
		double[] dsize = new double[1];
		int ret = gxxget(handle, value, row, col, font, dsize, color);
		size[0] = new BigDecimal(dsize[0]);
	...
	public int gxxget(double handle, int[] value, double row, double col, String[] font, BigDecimal[] size, long[] color)
	{
		double[] dsize = new double[1];
		int ret = gxxget(handle, value, row, col, font, dsize, color);
		size[0] = new BigDecimal(dsize[0]);
	...
	public int gxxget (double handle, double[] value, double row, double col, String[] font, BigDecimal[] size, long[] color)
	{				
		double[] dsize = new double[1];
		int ret = gxxget(handle, value, row, col, font, dsize, color);
		size[0] = new BigDecimal(dsize[0]);
	...
	public int gxxget(double handle, long[] value, double row, double col, String[] font, BigDecimal[] size, long[] color)
	{				
		double[] dsize = new double[1];
		int ret = gxxget(handle, value, row, col, font, dsize, color);
		size[0] = new BigDecimal(dsize[0]);
	...
	public int gxxget(double handle, java.util.Date[] value, double row, double col, String[] font, BigDecimal[] size, long[] color)
	{				
		double[] dsize = new double[1];
		int ret = gxxget(handle, value, row, col, font, dsize, color);
		size[0] = new BigDecimal(dsize[0]);
	...
	public int gxxget(double handle, BigDecimal[] value, double row, double col, String[] font, BigDecimal[] size, long[] color)
	{	
		double[] dsize = new double[1];
		int ret = gxxget(handle, value, row, col, font, dsize, color);
		size[0] = new BigDecimal(dsize[0]);
	...
	public void gxxgetformat(long handle, int row, int col, long[] color, String[] font, double[] size, int[] out)
	{
  	...
  	public int gxxputformat(long handle, long row, long col, long height, long width, long color, String font, double size)
	{
		return excel.PutFormat((short) handle, (int) row, (int) col, (int) height, (int) width, (int) color, font, size);
	}

  	public void gxxputformat(long handle, long row, long col, long height, long width, long color, String font, double size, int[] out)
	{
