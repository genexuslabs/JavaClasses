...
public final class handlequeueazureevent2 extends GXProcedure {
	...
	public com.genexus.genexusserverlessapi.SdtEventMessageResponse executeUdp(com.genexus.genexusserverlessapi.SdtEventMessages aP0) {
		handlequeueazureevent2.this.aP1 = new com.genexus.genexusserverlessapi.SdtEventMessageResponse[]{new com.genexus.genexusserverlessapi.SdtEventMessageResponse()};
		execute_int(aP0, aP1);
		return aP1[0];
	}
	...
	private void execute_int(com.genexus.genexusserverlessapi.SdtEventMessages aP0,
							 com.genexus.genexusserverlessapi.SdtEventMessageResponse[] aP1) {
		handlequeueazureevent2.this.AV8EventMessages = aP0;
		handlequeueazureevent2.this.aP1 = aP1;
		initialize();
		/* GeneXus formulas */
	...
	protected void cleanup() {
		this.aP1[0] = handlequeueazureevent2.this.AV9EventMessageResponse;
		CloseOpenCursors();
		exitApp();
	}
