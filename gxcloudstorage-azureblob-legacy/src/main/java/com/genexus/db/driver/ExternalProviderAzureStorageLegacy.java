...
public class ExternalProviderAzureStorageLegacy extends ExternalProviderBase implements ExternalProvider {
	private static Logger logger = LogManager.getLogger(ExternalProviderAzureStorageLegacy.class);
	...
	public ExternalProviderAzureStorageLegacy() throws Exception {
		super();
		init();
	}

	public ExternalProviderAzureStorageLegacy(GXService providerService) throws Exception {
