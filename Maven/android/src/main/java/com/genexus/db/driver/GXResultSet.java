// $Log: GXResultSet.java,v $
// Revision 1.29  2007/03/14 21:53:05  alevin
...
//
// Revision 1.28  2007/03/02 16:35:22  alevin
// - En el put anterior faltó no cerrar el stream cuando es null.
//
// Revision 1.27  2007/02/14 23:32:13  alevin
// - En el getBLOBFile faltaba cerrar el stream cuando el blob daba "vacio".
//
// Revision 1.26  2006/10/06 21:00:22  alevin
// - Implementacion del borrado de blobs temporales cuando se destruye el contexto o cuando
//   se destruyen las sessiones.
//
// Revision 1.25  2006/07/25 15:08:23  alevin
// - En la PrivateUtilities se agrego un overload del metodo getTempFileName que recibe el
//   base path y el name, ahora se llama a ese en el getBlobFileName.
//
// Revision 1.24  2006/07/24 21:16:11  alevin
// - Error en el put anterior, el getBlobFileName no estaba teniendo en cuenta el BLOB_PATH
//   cuando se le pasaba un name.
//
// Revision 1.23  2006/07/24 18:05:42  alevin
// - Cambio en el getBLOBFile para que reciba el nombre del archivo.
//
// Revision 1.22  2006/03/16 21:01:27  alevin
// - En el getBlobFileName, una vez que obtuve el directorio absoluto, lo uso de ahi
//   en adelante.
//
// Revision 1.21  2006/03/16 20:01:41  alevin
// - En el getBlobFile tengo que poner isEmptyBuffer = true si no se leyó  ningun byte.
//
// Revision 1.20  2006/03/16 15:58:28  alevin
// - Agrego el metodo getBlobFileName para retornar fileName del blob, en algunos
//  casos en una app web fallaba con tomcat. Ver comentario en el metodo.
//
// Revision 1.19  2006/01/12 15:21:14  alevin
// - Cambio en la getBLOBFile para soportar path relativos de la property
//   CS_BLOB_PATH en el caso WEB.
//
// Revision 1.18  2006/01/11 12:58:07  alevin
// - En la getBLOBFile se retorna el string vacio si el stream leido tiene un solo byte
//   y ese byte es un 0. Pasa que si se insertó un empty blob (un array bytes vacio)
//   cuando se lee, viene un array con un 0 como unico elemento.
//
// Revision 1.17  2005/12/21 17:08:45  dmendez
// El metodo read() del inputstream no hace lo que dice la doc.
// En la doc dice que retorna un integer entre 0 y 255, encontramos que en realidad retorna algo que parece ser un char de C con signo, por ejemplo en los jpg que comienzan con FF devuelve -1 !!.
//
// Usando el read con buffer el problema se resolvio.
//
// Revision 1.16  2005/11/22 17:56:36  iroqueta
...
//
// Revision 1.15  2005/11/22 13:28:47  iroqueta
// En el put anterior faltaba considerar un caso de nullPointerException
//
// Revision 1.14  2005/11/22 12:27:48  iroqueta
// Se estaba obteniendo mal el valor de los campos blob... se perdia el primer byte
//
// Revision 1.13  2005/10/25 13:32:02  iroqueta
// Cambio en el getBlobFile para que retorne en forma correcta si el blob es empty o sea si tiene 0 bytes.
//
// Revision 1.12  2005/10/07 14:09:56  alevin
// - Para hacer un getClob me fijo que no este ejecutando con la VM de MS porque
//   no soporta el getClob.
//
// Revision 1.11  2005/09/30 15:48:19  alevin
// - Cambio un poco el put anterior para el caso de que si falla la lectura del CLOB,
//   que lo lea con getString, como si fuera un LONG.
//
// Revision 1.10  2005/09/28 17:34:48  alevin
// - En el getLongVarChar, si el DBMS es Oracle y no se tiene la preference
//   LongVarCharAsOracleLong en true, se hace un getClob en lugar de un
//   getString.
//
// Revision 1.9  2005/06/02 16:19:35  iroqueta
// En el getBLOBFile pregunto a ver si es el caso que se grabo un array de bytes vacios. En ese caso retorno "" para que funcione en GX las funciones null y el metodo isEmpty()
//
// Revision 1.8  2005/04/21 14:00:40  iroqueta
// En el metodo close() atrapo las SQLException y en caso de que haya alguna lo tiro al final para que haga todo lo que tiene que hacer el metodo y no termine por la mitad
//
// Revision 1.7  2004/06/28 20:27:49  gusbro
// - Al obtener un datetime pongo a 0 los milisegundos
//
// Revision 1.6  2004/02/19 18:18:00  gusbro
// - Calculo el tamaño del result
//
// Revision 1.5  2003/06/26 18:28:31  gusbro
// - Cambios para soportar preference BLOB_PATH en tipos blob
//
// Revision 1.4  2003/04/21 18:11:48  aaguiar
// - Cambios en la implementacion del prepared statement cache
//
// Revision 1.3  2003/03/26 18:52:52  aaguiar
// - El getBlobFile devuelve el full path al archivo
//
// Revision 1.2  2002/12/30 18:57:30  aaguiar
// - La getBLOBFile recibe la extension como parametro
//
// Revision 1.1.1.1  2002/04/10 12:03:22  gusbro
