...
public final class GXDBDebug implements ICleanedup
{
	...
	public final void log(int handle, String text)
	{
		if	(logEnabled && log != null)
		{
			...
			log.println(com.genexus.GXutil.str(logLineCount++, 8, 0) + "(" + handle + ")" + "(" + time + ")" + text );
	...
	{
		return CommonUtil.padl(com.genexus.GXutil.ltrim(com.genexus.GXutil.str(number, length, 0)), length, "0");
	}
