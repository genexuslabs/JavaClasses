/*
               File: GetPendingEventAndCheckPointsByTimestamp
...
public final  class getpendingeventandcheckpointsbytimestamp extends GXProcedure implements IGxProcedure
{
   ...
   public getpendingeventandcheckpointsbytimestamp( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( getpendingeventandcheckpointsbytimestamp.class ), "" );
   }
   ...
   {
      getpendingeventandcheckpointsbytimestamp.this.AV5PendingEventStatus = aP0;
      getpendingeventandcheckpointsbytimestamp.this.aP1 = new GXBaseCollection[] {new GXBaseCollection<SdtGxSynchroEventSDT_GxSynchroEventSDTItem>()};
      initialize();
      privateExecute();
      return aP1[0];
   }
   ...
   {
      getpendingeventandcheckpointsbytimestamp.this.AV5PendingEventStatus = aP0;
      getpendingeventandcheckpointsbytimestamp.this.aP1 = aP1;
      initialize();
      /* GeneXus formulas */
      Gxm2rootcol = getpendingeventandcheckpointsbytimestamp.this.aP1[0];
   ...
   {
      this.aP1[0] = getpendingeventandcheckpointsbytimestamp.this.Gxm2rootcol;
      CloseOpenCursors();
      exitApplication();
   }
   ...
   public void initialize( )
   {
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new getpendingeventandcheckpointsbytimestamp__default(),
         new Object[] {
             new Object[] {
...
final  class getpendingeventandcheckpointsbytimestamp__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
                                          ...
                                          short A6PendingEventStatus )
   {
      ...
      if ( ! (0==AV5PendingEventStatus) )
      {
         ...
         sWhereString = sWhereString + " or ([PendingEventStatus] = 51)" ;
      }
      else
      {
         GXv_int1[0] = (byte)(1) ;
