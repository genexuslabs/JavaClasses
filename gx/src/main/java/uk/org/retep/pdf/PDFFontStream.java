 ...
 * @version 1.0
 */
public class PDFFontStream extends PDFStream implements Serializable
{
    /**
     ...
     * and is used by other objects that extend the PDFFontStream class (like
     * PDFImage).
     * <p>By default, the stream will be compressed.
     * @param type type for the stream
     * @see PDFImage
     */
    public PDFFontStream(String type) {
	super(type);
     ...
     *
     * <p>This is intended for anyone extending PDFFontStream, as objects
