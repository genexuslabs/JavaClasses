...
public class GXStatement implements Statement
{
	...
	*/
    public synchronized ResultSet executeQuery(String sql) throws SQLException
	{
		...
		con.setSentenceLastRequest(sql);		
	...
	*/
    public int executeUpdate(String sql) throws SQLException
	{
		...
		// Seteo ya el uncommited changes para que no me saquen la conexi�n
	...
	*/
	...
	/**
	* Esto se llama solo cuando se cierra la conexi�n real, o cuando se llego al maximo
...
//			con.setNotInUse(this);
    ...
    public void setFetchSize(int rows) throws SQLException
	{
		try
		{
			if(com.genexus.ModelContext.getModelContext() != null && com.genexus.ModelContext.getModelContext().getPreferences().getProperty("DontSetFetchSize", "0").equals("0"))
			{
