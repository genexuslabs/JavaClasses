...
public final  class SdtGridState_InputValuesItem extends GXXMLSerializable implements Cloneable, java.io.Serializable
{
                         ...
                         boolean sIncludeState )
   {
      ...
      oWriter.writeElement("Name", gxTv_SdtGridState_InputValuesItem_Name);
      if ( GXutil.strcmp(sNameSpace, "GeneXus") != 0 )
      {
         oWriter.writeAttribute("xmlns", "GeneXus");
      }
      oWriter.writeElement("Value", gxTv_SdtGridState_InputValuesItem_Value);
      if ( GXutil.strcmp(sNameSpace, "GeneXus") != 0 )
      {
         oWriter.writeAttribute("xmlns", "GeneXus");
      }
   ...
   public com.genexuscore.genexus.common.SdtGridState_InputValuesItem Clone( )
   {
      return (com.genexuscore.genexus.common.SdtGridState_InputValuesItem)(clone()) ;
   }

   public void setStruct( com.genexuscore.genexus.common.StructSdtGridState_InputValuesItem struct )
   {
   ...
   public com.genexuscore.genexus.common.StructSdtGridState_InputValuesItem getStruct( )
   {
      com.genexuscore.genexus.common.StructSdtGridState_InputValuesItem struct = new com.genexuscore.genexus.common.StructSdtGridState_InputValuesItem ();
