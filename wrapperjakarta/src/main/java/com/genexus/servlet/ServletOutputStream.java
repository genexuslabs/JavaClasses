...
public class ServletOutputStream implements IServletOutputStream{
	private jakarta.servlet.ServletOutputStream sos;

	public ServletOutputStream(jakarta.servlet.ServletOutputStream sos) {
		this.sos = sos;
	}
	...
	public jakarta.servlet.ServletOutputStream getWrappedClass() {
		return sos;
	}
